...
diferencia_max = este_curso * 1000// otros_cursos_max / 10 #Esto es para recortar un poco los decimales
diferencia_promedio = este_curso / otros_cursos_promedio * 100

#Calculo de que porcentaje de video se elimina
porcentaje_eliminado_este_curso = 100 - este_curso * 1000 // crudo_este_curso / 10
...
equivalencia_promedio = 10 / este_curso * 100 * otros_cursos_promedio // 100
